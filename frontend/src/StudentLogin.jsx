...
const StudentLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
        ...
        // Save the student's unique VIP wristband!
  ...
  return (
    <div className="glass-container">
      ...
      <p className="glass-subtitle">Student Portal Login</p>
      ...
      <form onSubmit={handleLogin}>
        ...
        <button type="submit" className="glass-button" style={{background: 'var(--success)'}}>Log In to Take Exams</button>
      </form>
    </div>
  );
};
